...
const ContactPage = ({actionData}:Route.ComponentProps) => {
    ...
    return (
        <div className="max-w-3xl mx-auto mt-12 px-6 py-8 bg-gray-900">
            ...
            <form method="post" className="space-y-6" action="https://formspree.io/f/mldpgwkd">
                <div>
                    <label htmlFor="name" className="block text-sm font-medium text0gray-300">Full Name</label>
                ...
                <div>
                    <label htmlFor="email" className="block text-sm font-medium text0gray-300">E-Mail</label>
                ...
                <div>
                    <label htmlFor="subject" className="block text-sm font-medium text0gray-300">Subject</label>
                ...
                <div>
                    <label htmlFor="message" className="block text-sm font-medium text0gray-300">Message</label>
